    ...
    <div className="min-h-screen bg-[#faf8f6]">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-sm border border-[#8a4a22]/10 p-8 md:p-12">
          <h1 className="text-3xl font-bold text-[#2c1208] mb-6">Help Center</h1>
          <div className="prose prose-orange max-w-none text-[#5a2c14]">
            ...
            <h2 className="text-xl font-bold text-[#2c1208] mt-8 mb-4">Frequently Asked Questions</h2>
            <div className="space-y-6">
              <div>
                <h3 className="font-semibold text-[#8a4a22] mb-2">How do I access my induction pass?</h3>
              ...
              <div>
                <h3 className="font-semibold text-[#8a4a22] mb-2">What if I forget my password?</h3>
              ...
              <div>
                <h3 className="font-semibold text-[#8a4a22] mb-2">Who should I contact for technical support?</h3>
                <p>For technical support regarding the platform, please reach out to the EOZKA support team at support@eozka.com.</p>
              </div>
            </div>

            <div className="mt-12 p-6 bg-[#faf8f6] rounded-xl border border-[#8a4a22]/10">
              <h3 className="text-lg font-bold text-[#2c1208] mb-2">Need further assistance?</h3>
