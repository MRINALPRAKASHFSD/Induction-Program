...
/** /my-pass now silently redirects to /dashboard.
 * The MyPassPage component is exported so dashboard.lazy.tsx can import it
 * without duplicating code. Old bookmarks/links to /my-pass still work. */
export const Route = createLazyFileRoute("/my-pass")({
  component: MyPassRedirect,
});

function MyPassRedirect() {
...
export function MyPassPage() {
  ...
  const {
    ...
    planner,
    plannerLoading
  } = useDashboardData(firebaseUser, authLoading);
  ...
  return (
    <>
      ...
      <DashboardContent 
        ...
        liveRoomAssignment={liveRoomAssignment}
...
export interface DashboardContentProps {
  ...
  liveRoomAssignment: any | null;
  livePoints: number | null;
  liveStudent: any | null;
  registrations: any[];
  clubs: any[];
}
