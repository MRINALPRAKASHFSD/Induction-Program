                 ...
                 <div className="space-y-8 sm:space-y-10">
                    ...
                    <div className="space-y-6">
                      ...
                      <Field label="Full Name">
                        <IconInput icon={User} required minLength={2} value={form.full_name} onChange={(e: any) => update("full_name", e.target.value)} placeholder="e.g. Aarav Sharma" />
                      </Field>

                      <div className="grid gap-6 sm:grid-cols-2">
                        <Field label="Enrollment Number">
                          <IconInput icon={Hash} required value={form.enrollment_no} onChange={(e: any) => update("enrollment_no", e.target.value)} placeholder="KRMU24CS0001" className="uppercase" />
                        </Field>
                        <Field label="Phone (optional)">
                          <IconInput icon={Phone} type="tel" value={form.phone} onChange={(e: any) => update("phone", e.target.value)} placeholder="+91 9xxxxxxxxx" />
                        </Field>
                      </div>
                    </div>

                    {/* Section 2: Digital Verification */}
                    <div className="space-y-6">
                      <div className="flex items-center gap-3 border-b border-border/30 pb-3">
                        <div className="h-6 w-1.5 rounded-full bg-primary"></div>
                        <h3 className="font-bold text-xl tracking-tight">2. Digital Verification</h3>
                      </div>
                      ...
                      <div className="grid gap-2.5 relative">
                        ...
                        <div className="relative flex items-center">
                          <div className={`absolute left-3 flex h-full items-center justify-center transition-colors ${emailVerified ? "text-emerald-500" : "text-muted-foreground"}`}>
                          ...
                          <Input
                            ...
                            className={`pl-10 h-12 text-[15px] bg-background/50 border-border/50 transition-all ${emailVerified ? "border-emerald-500/50 focus-visible:ring-emerald-500/30 bg-emerald-500/5" : "focus-visible:border-primary/50 focus-visible:ring-primary/20"}`}
                          />
                          {!emailVerified && !verifyingEmail && (
                            <div className="absolute right-1.5">
                              <button
                                ...
                                className="inline-flex items-center gap-1.5 text-[13px] font-semibold px-4 py-2 rounded-lg border border-border/60 bg-background hover:bg-muted hover:text-foreground text-muted-foreground transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                              >
                                {sendingOtp ? (
                                  <>
                        ...
                        {!emailVerified && (
                          <p className="text-xs text-muted-foreground flex items-center gap-1.5 mt-1 font-medium">
                            ...
                            Use your primary email. This is required for your entry pass.
                          </p>
                        )}
                            ...
                            >
                              <div className="flex flex-col gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-5 relative overflow-hidden shadow-inner">
                                ...
                                <p className="text-[13px] text-foreground/80 leading-relaxed">
                                  Enter the 6-digit code sent to <span className="font-bold text-foreground">{form.email}</span>. 
                                  <br/>
                                  <span className="text-yellow-600 dark:text-yellow-500 font-medium inline-block mt-0.5">Please check your spam/junk folder if you don't receive it in a minute.</span>
                                </p>
                                <div className="flex items-center gap-3">
                                  ...
                                  <button
                                    ...
                                    className="inline-flex items-center justify-center gap-2 text-[15px] font-bold px-6 h-14 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap shadow-md shadow-primary/20 hover:shadow-lg hover:shadow-primary/30"
                                  >
                                    {sendingOtp ? (
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center gap-3 border-b border-border/30 pb-3">
                        <div className="h-6 w-1.5 rounded-full bg-primary"></div>
                        <h3 className="font-bold text-xl tracking-tight">3. Academic Profile</h3>
                      </div>
                        ...
                        <Field label="Program">
                          <div className="relative flex items-center w-full min-w-0">
                            ...
                            <Select value={form.branch} onValueChange={(v) => update("branch", v)} disabled={!form.department_id}>
                              <SelectTrigger className="pl-10 h-12 text-[15px] bg-background/50 border-border/50 focus:ring-primary/20 [&>span]:truncate"><SelectValue placeholder={form.department_id ? "Select program" : "Pick school first"} /></SelectTrigger>
                              <SelectContent>
                                {branches.map((b) => (
