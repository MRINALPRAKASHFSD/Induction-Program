...
content = """import { type LocalStudent } from "@/lib/local-db";
...
with open("src/components/dashboard/dashboard-hero.tsx", "w", encoding="utf-8") as f:
    f.write(content)

print("Updated dashboard-hero.tsx")
